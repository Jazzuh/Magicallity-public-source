    ...
    public class SafeCracking : ClientAccessor
    {
        ...
        private void ReleaseCurrentPin()
        {
            try
            {
                ...
                API.PlaySoundFrontend(0, IsSafeUnlocked() ? "TUMBLER_PIN_FALL_FINAL" : "TUMBLER_PIN_FALL",
        ...
        private void RotateSafeDial(RotationDirections rotationDirection)
        {
            try
            {
                ...
                API.PlaySoundFrontend(0, "TUMBLER_TURN", "SAFE_CRACK_SOUNDSET", true);
        ...
        private void ResetSafeLocks()
        {
            try
            {
                ...
                API.PlaySoundFrontend(0, "TUMBLER_RESET", "SAFE_CRACK_SOUNDSET", true);
            }
            catch (Exception ex)
            {
                Log.Error(ex);
        ...
        internal async Task OpenSafeDoor()
        {
            try
            {
                ...
                API.PlaySoundFrontend(0, "SAFE_DOOR_OPEN", "SAFE_CRACK_SOUNDSET", true);
        ...
        internal async Task CloseSafeDoor()
        {
            try
            {
                ...
                API.PlaySoundFrontend(0, "SAFE_DOOR_CLOSE", "SAFE_CRACK_SOUNDSET", true);
