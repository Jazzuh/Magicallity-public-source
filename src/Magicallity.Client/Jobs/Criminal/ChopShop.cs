...
namespace Magicallity.Client.Jobs.Criminal
{
    internal class ChopShop : JobClass
    {
        ...
        private Vector3 chopShopExit = new Vector3(970.58f, -2990.94f, -40.70f);
        ...
        private void giveVehCompletionAward(int rewardPrice)
        {
            ...
            Client.TriggerServerEvent("Job.RequestRemoteJobPayment", rewardTotal, "chop shop");
            if (currentVehicleList.Count == 0)
            {
                ...
                Client.TriggerServerEvent("Job.RequestRemoteJobPayment", rand.Next(150, 300), "chop shop extra pay");
            }
        }
