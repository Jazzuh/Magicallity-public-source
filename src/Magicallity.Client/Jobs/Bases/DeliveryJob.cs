...
namespace Magicallity.Client.Jobs.Bases
{
    public abstract class DeliveryJob : JobClass, IJob
    {
        ...
        protected VehicleHash DeliveryVehicleHash = VehicleHash.Pony;
        ...
        protected virtual async Task<Vehicle> spawnJobVehicle()
        {
            ...
            Magicallity.Client.Client.Instance.TriggerServerEvent("Vehicle.CreateExternalVehicle", VehicleDataPacker.PackVehicleData(veh));
