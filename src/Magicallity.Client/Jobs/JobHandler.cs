...
namespace Magicallity.Client.Jobs
{
    public sealed class JobHandler : ClientAccessor
    {
        ...
        {
            Magicallity.Client.Client.Instance.TriggerServerEvent("Job.SetPlayerJob", job.ToString());
        }
        ...
        public void SetDutyState(bool state) => Magicallity.Client.Client.Instance.TriggerServerEvent("Job.SetDutyState", state);
