...
async function OnLoginRequest(elem) {
    ...
    $.post("http://magicallitymain/Login.LoadCharacters", JSON.stringify({}));
}
...
async function OnDoLogin(elem) {
    ...
    $.post("http://magicallitymain/Login.SelectChar", JSON.stringify({
...
async function OnCreateCharacter() {
    ...
    $.post("http://magicallitymain/Login.CreateCharacter", JSON.stringify({
        firstName: firstName,
        lastName: lastName,
        DOB: dob
    }));
...
async function OnCharacterDelete(charId) {
    ...
    $.post("http://magicallitymain/Login.DeleteChar", JSON.stringify({
        charId: charId
    }));
}
...
window.addEventListener("DOMContentLoaded", function() {
    $.get("https://api.magicallityrp.com/fivem/patchnotes.php", function(data) {
