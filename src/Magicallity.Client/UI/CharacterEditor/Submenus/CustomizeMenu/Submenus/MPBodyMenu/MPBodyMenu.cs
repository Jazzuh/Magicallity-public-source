...
using Magicallity.Client.UI.Menus.CharacterEditor.MPBodyMenu;
using MenuFramework;

namespace Magicallity.Client.UI.Menus.CharacterEditor.CustomizeMenu
{
    internal class MPBodyMenu : MenuModel
	{
		private CharacterEditorMenu Root;

	    private ItemSelector FatherHead;
	    private ItemSelector MotherHead;
	    private ItemSlider HeadWeight;
	    private ItemSelector FacialFeatures;
	    private ItemSlider FacialMorphStrength;
	    private ItemSelector FatherSkin;
	    private ItemSelector MotherSkin;
	    private ItemSlider SkinWeight;
