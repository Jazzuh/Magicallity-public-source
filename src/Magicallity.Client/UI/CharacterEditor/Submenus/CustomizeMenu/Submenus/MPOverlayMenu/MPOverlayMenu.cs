...
using Magicallity.Client.UI.Menus.CharacterEditor.MPOverlayMenu;
using MenuFramework;

namespace Magicallity.Client.UI.Menus.CharacterEditor.CustomizeMenu
{
    internal class MPOverlayMenu : MenuModel
	{
		private CharacterEditorMenu Root;

	    private static List<PedHeadOverlay> overlays = new List<PedHeadOverlay>()
		{
	    ...
	    private static Dictionary<int, int> overlayColors = new Dictionary<int, int>();
