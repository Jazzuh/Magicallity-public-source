...
using Magicallity.Client.Menus.CharacterEditor.MainMenu;
using Magicallity.Client.Helpers;
using Magicallity.Client.Player.Clothing;
using MenuFramework;
...
namespace Magicallity.Client.UI
{
    ...
    public class PedData
    {
        ...
        public Dictionary<string, dynamic> getSaveableData(bool isClothingStore = false, bool keepModel = false)
        {
            ...
            skinItems["Tattoos"] = keepModel ? Tattoos : Magicallity.Client.Player.Clothing.Tattoos.CurrentTattoos;
