...
namespace Magicallity.Client.UI
{
    class InteractionUI : ClientAccessor
    {
        ...
        private static List<string> walkingStyles = new List<string>() { "Reset to default", "move_m@injured", "move_m@gangster@generic", "move_m@gangster@ng", "move_m@buzzed", "move_m@drunk@a", "move_f@hurry@a", "move_f@femme@", "move_f@arrogant@a", "move_m@sassy", "move_m@quick", "move_m@tough_guy@", "move_m@alien", "move_m@hobo@a", "move_m@money", "move_m@swagger", "move_m@posh@", "move_m@sad@a", "move_m@shadyped@a", "move_m@drunk@slightlydrunk", "move_m@drunk@verydrunk", "move_f@arrogant@a", "move_f@arrogant@b", "move_f@arrogant@c", "move_f@heels@c", "move_f@heels@d", "move_f@sassy", "move_f@posh@", "move_f@maneater", "move_f@chichi", "move_m@swagger" }; 
