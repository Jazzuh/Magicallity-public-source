...
namespace Magicallity.Client.Enviroment
{
    public class Banks : ClientAccessor
    {
        ...
        private void OnWithdrawRequest(Command cmd)
        {
            ...
            {
                Magicallity.Client.Client.Instance.TriggerServerEvent("Bank.AttemptWithdraw", cmd.GetArgAs(0, 0));
            }
        }
        ...
        private void OnDepositRequest(Command cmd)
        {
            if (isCloseToBank())
            {
                Magicallity.Client.Client.Instance.TriggerServerEvent("Bank.AttemptDeposit", cmd.GetArgAs(0, 0));
            }
        }
