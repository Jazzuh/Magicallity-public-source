...
namespace Magicallity.Client.Player.Clothing
{
    internal class SkinHandler : ClientAccessor
    {
        ...
        public async void RefreshPlayerSkin()
        {
            ...
            if (LocalSession.GetGlobalData("Character.SkinData", "") != "")
            {
        ...
        {
            Magicallity.Client.Client.Instance.TriggerServerEvent("Skin.AddOutfitToPlayer", outfitName, JsonConvert.SerializeObject(new PedData().getSaveableData(true)));
        }
    }
}
