...
using Magicallity.Server.Property;
using Magicallity.Server.Realtor.Models;
...
namespace Magicallity.Server.Realtor
{
    ...
    public class PropertyManager : ServerAccessor
    {
        ...
        public void RegisterPropertyToDatabase(PropertyModel property)
        {
            ...
            MySQL.execute("INSERT INTO property_data (`OwnerID`, `PropertyID`, `Address`, `StorageLocation`, `StorageSize`, `GarageLocation`, `GarageMaxVehicles`, `EntranceLocation`, `InteriorID`) VALUES (@owner, @propid, @address, @storeloc, @storesize, @garageloc, @garagevehs, @entranceloc, @interiorid)", new Dictionary<string, dynamic>
            {
