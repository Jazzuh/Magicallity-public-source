...
namespace Magicallity.Server.HTTP
{
    ...
    public class HTTPRequest : BaseScript
    {
        public HTTPRequest() { }

        public async Task<RequestResponse> Request(string url, string method = "GET", string data = "", Dictionary<string, string> headers = null)
        {
