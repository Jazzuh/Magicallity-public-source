...
namespace Magicallity.Server.Models
{
...
#region Bank
        private static CachedConvar<int> bankStartingBalanceConvar = new CachedConvar<int>("bank_starting_bank_balance", 15000, 60000);
...
#region Paycheck
        ...
        private static CachedConvar<int> paycheckTowConvar = new CachedConvar<int>("paycheck_tow", 150);
        public static int PaycheckTow => paycheckTowConvar.Value;

        private static CachedConvar<int> paycheckCivillianConvar = new CachedConvar<int>("paycheck_civillian", 50);
        ...
        private static CachedConvar<int> paycheckTaxiConvar = new CachedConvar<int>("paycheck_taxi", 150);
        public static int PaycheckTaxi => paycheckTaxiConvar.Value;

        private static CachedConvar<int> paycheckDeliveryConvar = new CachedConvar<int>("paycheck_delivery", 0);
