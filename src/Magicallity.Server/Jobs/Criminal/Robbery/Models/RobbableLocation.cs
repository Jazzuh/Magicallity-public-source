...
namespace Magicallity.Server.Jobs.Criminal.Robbery.Models
{
    public abstract class RobbableLocation
    {
        ...
        protected RobbableLocation(string locaitonName)
        {
            ...
            defaultRequiredPoliceConvar = new CachedConvar<int>($"job_robbery_{GetLocationType()}_default_required_police", 3, 60000);
