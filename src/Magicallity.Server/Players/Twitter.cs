...
namespace Magicallity.Server.Players
{
    public class Twitter : ServerAccessor
    {
        public Twitter(Server server) : base(server)
        {
            ...
            CommandRegister.RegisterCommand("mutetwitter|mtwitter", OnMuteTwitter);
        }
        ...
        public Dictionary<string, dynamic> UpdateTwitterHandle(Session.Session playerSession, string newHandle)
        {
            ...
            playerSession./*SetCharacterSettings()*/CharacterSettings = playerSettings;
        ...
        private void OnTweetCommand(Command cmd)
        {
            ...
            {
                if (player./*GetPlayerSettings()*/PlayerSettings.ContainsKey("MuteTwitter") && player./*GetPlayerSettings()*/PlayerSettings["MuteTwitter"]) return;
