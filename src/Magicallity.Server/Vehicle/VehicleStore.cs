...
using static Magicallity.Shared.VehicleStoreItems;
...
namespace Magicallity.Server.Vehicle
{
    internal class VehicleStore : ServerAccessor
    {
        ...
        {
            MySQL.execute("INSERT INTO vehicle_data (`CharID`, `SteamID`, `VehicleName`, `Plate`, `Mods`, `VehiclePrice`) VALUES (@char, @steam, @name, @plate, @mods, @price)", new Dictionary<string, dynamic>
            {
