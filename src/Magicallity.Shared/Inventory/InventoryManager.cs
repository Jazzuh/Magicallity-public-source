...
/// <param name="itemAmount">Amount of the <see cref="inventoryItem"/> wanting to be added</param>
        public void AddItem(string item, int itemAmount) => Magicallity.Client.Client.Instance.TriggerServerEvent("Inventory.AddInvItem", item, itemAmount);
        ...
        public void AddItem(string item, int itemAmount, string vehiclePlate) => Magicallity.Client.Client.Instance.TriggerServerEvent("Inventory.AddInvItem", item, itemAmount, vehiclePlate);
