...
namespace Magicallity.Shared
{
    ...
    public static class InventoryItems
    {
        public static readonly Dictionary<string, inventoryItem> inventoryItems = new Dictionary<string, inventoryItem>()
        {
            ...
            // MISC / Unused
            //["t2rod"] = new inventoryItem { itemName = "Professional rod", itemCode = "t2rod", interactionEvent = "", interactionAction = "", interactionData = "5", isIllegal = false, isUseable = false, itemWeight = 12.0f },
            //["t3rod"] = new inventoryItem { itemName = "Expert rod", itemCode = "t3rod", interactionEvent = "", interactionAction = "", interactionData = "5", isIllegal = false, isUseable = false, itemWeight = 12.0f },
            ...
            ["WEAPON_SNOWBALL"] = new inventoryItem { itemName = "Snowball", itemCode = "WEAPON_SNOWBALL", interactionEvent = "", interactionAction = "", interactionData = "0", isIllegal = true, isUseable = false, itemWeight = 0.0f },
